...
public class CloseAccountCommand implements CustomCommand {
    ...
    public Batch execute(Batch requestBatch) {
        ...
        try {
            result = accountService.closeAccount(accountId);
        } catch (ServiceException e) {
            LOGGER.log(Level.ERROR, "Error while closing account", e);
        }
